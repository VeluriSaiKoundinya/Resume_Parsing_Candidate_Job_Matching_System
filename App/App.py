...
st.set_page_config(
   page_title="Resume Parsing and Candidate Matching System",
...
def run():
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                ds_keyword = ['tensorflow','keras','pytorch','machine learning','deep Learning','flask','streamlit','power bi','data analysis']
                web_keyword = ['react', 'django', 'node jS', 'react js', 'php', 'laravel', 'magento', 'wordpress','javascript', 'angular js', 'C#', 'Asp.net', 'flask','spring boot','Servlets','API','vue js']
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        st.subheader("**About The Tool - Resume Parsing And Candiadte Matching System**")
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>admin</b> as username and <b>admin123</b> as password.<br/>
